...
#        self.linear_c1 = conv(input_dim=c1_in_channels, embed_dim=embedding_dim)
        ...
        self.conv_0 = nn.Conv2d(c3_in_channels, 256, kernel_size=3, stride=1, padding=1)
...
class cvt_PUP(nn.Module):
    def __init__(self, class_num=2, **kwargs):
        super(cvt_PUP, self).__init__()
...
MitEncoder = cvt_PUP(class_num=1)
from torchinfo import summary
summary(MitEncoder, (16, 3, 352, 352))
