...
class ssa_mla(nn.Module):
    def __init__(self, class_num=2, **kwargs):
        super(ssa_mla, self).__init__()
        self.class_num = class_num
        ######################################load_weight
        self.backbone = shunted_s()
        #####################################
        self.decode_head = Decoder(dims=[64, 128, 256, 512], dim=128, class_num=class_num)
...
MitEncoder = ssa_mla(class_num=1)
